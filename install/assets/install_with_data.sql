...
--
-- Host: localhost:3306
-- Generation Time: Nov 24, 2016 at 11:06 AM
...
--
-- Database: `minds3vp_tutorsci_demo`
--
...
CREATE TABLE IF NOT EXISTS `pre_admin_money_transactions` (
...
CREATE TABLE IF NOT EXISTS `pre_calendar_timezones` (
...
CREATE TABLE IF NOT EXISTS `pre_certificates` (
...
CREATE TABLE IF NOT EXISTS `pre_country` (
...
CREATE TABLE IF NOT EXISTS `pre_course_categories` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `course_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='For course_id and category_id, refer pre_categories tbl(is_parent=0 mean course)' AUTO_INCREMENT=307 ;
...
CREATE TABLE IF NOT EXISTS `pre_email_templates` (
...
CREATE TABLE IF NOT EXISTS `pre_faqs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_gallery` (
...
CREATE TABLE IF NOT EXISTS `pre_inst_batches` (
...
CREATE TABLE IF NOT EXISTS `pre_inst_enrolled_students` (
...
CREATE TABLE IF NOT EXISTS `pre_inst_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inst_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pre_inst_offered_courses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inst_id` int(11) NOT NULL,
  `course_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `pre_inst_teaching_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inst_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pre_languages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_languagewords` (
  `lang_id` bigint(22) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_login_attempts` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_messages` (
...
CREATE TABLE IF NOT EXISTS `pre_newsletter_subscriptions` (
...
CREATE TABLE IF NOT EXISTS `pre_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(512) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pre_scroll_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_sitetestimonials` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_student_leads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='student posted requirements' AUTO_INCREMENT=53 ;
...
CREATE TABLE IF NOT EXISTS `pre_student_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `student_id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `pre_student_prefferd_teaching_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `student_id` int(11) NOT NULL,
  `teaching_type_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `pre_student_preffered_courses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `student_id` int(11) NOT NULL,
  `course_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `pre_subscriptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `pre_subscriptions` (`id`, `user_id`, `user_name`, `user_type`, `package_id`, `package_name`, `package_cost`, `amount_paid`, `credits`, `payment_type`, `transaction_no`, `payment_received`, `payer_id`, `payer_email`, `payer_name`, `subscribe_date`, `user_group_id`, `discount_type`, `discount_value`, `discount_amount`) VALUES
(1, 2, 'Ayzlee Rayhanna', 'Student', 4, 'Premium-Student', '250.00', '200.00', 500, 'paypal', '21K402382U8535517', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-09 10:24:39', 2, 'Value', '50.00', '50.00'),
(2, 2, 'Ayzlee Rayhanna', 'Student', 4, 'Premium-Student', '250.00', '200.00', 500, 'paypal', '1V338340YY472823Y', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-09 18:10:58', 2, 'Value', '50.00', '50.00'),
(3, 3, 'Azalya Abia', 'Student', 4, 'Premium-Student', '250.00', '200.00', 500, 'paypal', '4V718323JN811142S', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-09 18:13:05', 2, 'Value', '50.00', '50.00'),
(4, 4, 'Azani Nathalya', 'Student', 10, 'General Package', '400.00', '300.00', 600, 'paypal', '7WP86557G9989052S', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-09 18:16:33', 2, 'Percent', '25.00', '0.16'),
(5, 5, 'Bae Mirage', 'Student', 10, 'General Package', '400.00', '300.00', 600, 'paypal', '8LL287302V358745B', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-09 18:20:14', 2, 'Percent', '25.00', '0.16'),
(6, 6, 'Baeleigh Elmina', 'Student', 10, 'General Package', '400.00', '300.00', 600, 'paypal', '30M88992015694421', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-09 18:22:32', 2, 'Percent', '25.00', '0.16'),
(7, 6, 'Baeleigh Elmina', 'Student', 10, 'General Package', '400.00', '300.00', 600, 'paypal', '808074201K323703C', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-09 18:24:25', 2, 'Percent', '25.00', '0.16'),
(8, 68, 'Augustine Alondra', 'Tutor', 2, 'Gold-Tutor', '500.00', '400.00', 1000, 'paypal', '5Y791014FM513844T', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-10 16:00:21', 3, 'Percent', '20.00', '0.25'),
(9, 3, 'Azalya Abia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 1000, 'paypal', '6A613030LY069860G', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 09:56:32', 2, 'Percent', '20.00', '0.25'),
(10, 7, 'Behati Corinn', 'Tutor', 2, 'Gold-Tutor', '500.00', '400.00', 1000, 'paypal', '5BS17548SU5785238', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:26:49', 3, 'Percent', '20.00', '0.25'),
(11, 7, 'Behati Corinn', 'Tutor', 2, 'Gold-Tutor', '500.00', '400.00', 1000, 'paypal', '1MV39455DX619380M', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:27:56', 3, 'Percent', '20.00', '0.25'),
(12, 68, 'Augustine Alondra', 'Tutor', 10, 'General Package', '400.00', '300.00', 600, 'paypal', '792051284F7017312', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:41:17', 3, 'Percent', '25.00', '0.16'),
(13, 3, 'Azalya Abia', 'Student', 10, 'General Package', '400.00', '300.00', 600, 'paypal', '32F79929LT764201V', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:43:48', 2, 'Percent', '25.00', '0.16'),
(14, 13, 'Bebe Esmie', 'Institute', 3, 'Gold-Inst', '500.00', '400.00', 1000, 'paypal', '1R158414TP429642A', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:54:51', 4, 'Percent', '20.00', '0.25'),
(15, 13, 'Bebe Esmie', 'Institute', 3, 'Gold-Inst', '500.00', '400.00', 1000, 'paypal', '00W599051E6952700', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:55:32', 4, 'Percent', '20.00', '0.25'),
(16, 3, 'Azalya Abia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 1000, 'paypal', '0CD25117SU193104N', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:57:21', 2, 'Percent', '20.00', '0.25'),
(17, 3, 'Azalya Abia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 1000, 'paypal', '5K7073630V866371S', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 10:58:11', 2, 'Percent', '20.00', '0.25'),
(18, 3, 'Azalya Abia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 1000, 'paypal', '70375747MN851504T', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 11:37:44', 2, 'Percent', '20.00', '0.25'),
(19, 3, 'Azalya Abia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 1000, 'paypal', '7S719111NG8182002', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 11:38:42', 2, 'Percent', '20.00', '0.25'),
(20, 7, 'Behati Corinn', 'Tutor', 2, 'Gold-Tutor', '500.00', '400.00', 3000, 'paypal', '50U231977C2843428', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 11:43:35', 3, 'Percent', '20.00', '0.25'),
(21, 3, 'Azalya Abia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 3000, 'paypal', '0MY33677VD420915M', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 11:46:13', 2, 'Percent', '20.00', '0.25'),
(22, 3, 'Azalya Abia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 3000, 'paypal', '69L05456YA8300416', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-11 11:46:54', 2, 'Percent', '20.00', '0.25'),
(23, 32, 'Mahaila Fortune', 'Student', 1, 'Gold-Student', '500.00', '400.00', 3000, 'paypal', '67K07783T4331553B', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-14 11:56:00', 2, 'Percent', '20.00', '0.25'),
(24, 33, 'Mahati Harliee', 'Student', 1, 'Gold-Student', '500.00', '400.00', 3000, 'paypal', '5CD45298DH208503U', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-14 12:04:16', 2, 'Percent', '20.00', '0.25'),
(25, 34, 'Mahelet Dalasia', 'Student', 1, 'Gold-Student', '500.00', '400.00', 3000, 'paypal', '3JP79634TV347883S', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-14 12:09:54', 2, 'Percent', '20.00', '0.25'),
(26, 29, 'Maesa Karthika', 'Student', 10, 'General Package', '400.00', '300.00', 600, 'paypal', '9GX40556X47317447', 1, 'F2TMN4DXTNFZS', 'conqtech7-buyer@gmail.com', 'test buyer', '2016-11-21 12:35:07', 2, 'Percent', '25.00', '0.16');
...
CREATE TABLE IF NOT EXISTS `pre_system_settings_fields` (
...
CREATE TABLE IF NOT EXISTS `pre_system_settings_types` (
...
CREATE TABLE IF NOT EXISTS `pre_teaching_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(256) DEFAULT NULL,
  `position` varbinary(256) DEFAULT NULL,
  `description` text,
...
CREATE TABLE IF NOT EXISTS `pre_terms_data` (
...
CREATE TABLE IF NOT EXISTS `pre_testimonials` (
  `testimony_id` int(25) NOT NULL AUTO_INCREMENT,
  `user_id` int(25) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pre_tutor_courses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tutor_id` int(11) NOT NULL,
  `course_id` int(11) NOT NULL,
  `duration_value` tinyint(5) NOT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='are the courses teached by tutors' AUTO_INCREMENT=99 ;
...
CREATE TABLE IF NOT EXISTS `pre_tutor_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tutor_id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1-active, 0-inactive',
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='locations in which tutor willing to provide his services' AUTO_INCREMENT=1348 ;
...
CREATE TABLE IF NOT EXISTS `pre_tutor_reviews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_tutor_selected_types` (
...
CREATE TABLE IF NOT EXISTS `pre_tutor_teaching_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tutor_id` int(11) NOT NULL,
  `teaching_type_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1-active, 0-inactive',
...
(2, '::1', 'Ayzlee Rayhanna', 'ayzlee-rayhanna', '$2y$08$e.RfRKrbtPbYTxQzyKHIwuHiUZGT/AyZIhkvui8xAo3Q4889jjcRq', NULL, 'raju72314@gmail.com', '677ee0755f6053e7893e8765cd17de6f4f0b3ac9', NULL, NULL, NULL, 1478585457, 1479979191, 1, 'Ayzlee', 'Rayhanna', '1990-08-08', 'Male', NULL, '1', '7207757581', '', '', '2.jpg', 0, 'English,French,Hindi', 0, 'Months', NULL, '', 'All', '1', '1', 'I Completed B.Tech and looking for a tutor who can help in M.Tech .', 0, 'B.Tech', 0, 1, 'facebook.com', 'twitter.com', 'linkedin.com', 'ayzlee12 @ gmail.com', '0', 'no', '', 'Ayzlee Rayhanna', '5.00', 'yes', 'white house', 'United States', '417147', NULL, NULL, 'yes', 'yes', 'no', 'no', 'New York', 2, 2, 'Yes', 'No', NULL, NULL, NULL, 950, 0, '2016-11-10 09:55:52'),
(3, '::1', 'Azalya Abia', 'azalya-abia', '$2y$08$IK16bEIjBaRRtB659BZzdOlda1SzlN.aNkzu8d5Hd16OCro0O/ODq', NULL, 'micheljohn930@gmail.com', '8312c72caa857b3533ba3848f14a2f9413b7f08d', NULL, NULL, NULL, 1478585514, 1479968938, 1, 'Azalya', 'Abia', '1995-11-10', 'Male', NULL, '1684', '7207757581', '', '', '3.jpg', 0, 'English,Arabic,Dutch', 0, 'Months', NULL, '', 'Email', '1', '1', 'Hi i am Azalya . I Completed  My Graduation . I am looking for Good Tutors to learn things', 0, 'B.Tech', 0, 1, '', '', '', 'micheljohn930@gmail.com', '0', 'no', '', 'Azalya Abia', '6.00', 'yes', 'white house', 'United States', '417147', NULL, NULL, 'yes', 'yes', 'no', 'no', 'New York', 2, 22, 'No', 'No', NULL, NULL, NULL, 1025, 0, '2016-11-23 16:18:55'),
...
CREATE TABLE IF NOT EXISTS `pre_users_certificates` (
  `user_certificate_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pre_users_education` (
...
CREATE TABLE IF NOT EXISTS `pre_users_experience` (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pre_users_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pre_users_reviews` (
...
CREATE TABLE IF NOT EXISTS `pre_user_credit_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `credits` int(11) NOT NULL,
  `per_credit_value` float NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `pre_user_status_texts` (
...
CREATE TABLE IF NOT EXISTS `pre_yesno_status_texts` (
  `value` tinyint(1) NOT NULL,
