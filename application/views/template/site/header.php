            ...
            <div class="collapse navbar-collapse" id="mega-nav-menu">
                <ul class="nav navbar-nav navbar-right">
					...
					<?php } else {
						...
						//if($current_controller != $ctrl)
						{
						?>
						<li>
                        <a href="<?php echo $url;?>"> <span class="nav-btn"> <i class="fa  fa-sign-in"></i> &nbsp; <?php echo get_languageword('My Dashboard');?></span>
                        </a>
						</li>
						<li>
                        <a href="<?php echo URL_AUTH_LOGOUT;?>"> <span class="nav-btn"> <i class="fa  fa-sign-in"></i> &nbsp; <?php echo get_languageword('Logout');?></span>
                        </a>
						</li>
						<?php
						}
